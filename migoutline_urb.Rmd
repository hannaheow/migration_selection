...
load("H:/amy/migration/3mods/22yearsmort_norace.RData") #the name of this dataset is sc for statecounty 
...
load("H:/amy/migration/3mods/22yearsmort_norace.RData")
...
load("H:/amy/migration/3mods/12yearsmigfixed.RData")
