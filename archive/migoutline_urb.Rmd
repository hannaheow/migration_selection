...
<!-- # Notes from the high throughput computing intro meeting  -->
<!-- hierarchical model, multilevel, mixed/random effects  -->
<!-- mle? or bayesian? rstan package  -->


<!-- no gui  -->
<!-- need to save as script files (.R) that can be executed via command line -->
<!-- how to save output?  -->
<!-- gpu versus cpu - gpu better for ML, some packageshave this built in but cpu is default  -->

<!-- 1) set up executable, data, program, scripts, etc  -->
<!-- 2) prepare submit file for job - this is the file needed by HTCondor ; can submit many jobs with a single submit file  -->
<!-- 3) submit jobs with condor_submit name.sub  -->
<!-- a) process submit file to determine where and when to run the job  -->
<!-- b) transfer files specified in submit file  -->
<!-- c) run the main script (executable) -->
<!-- d) transfer back the outputs(ie job finished) -->


<!-- interactive job  -->
<!-- 1) prepare submit file for interactive job  -->
<!-- 2) submit interactive job with condor_submit -i name.sub  -->
<!-- a) process submit file to determine where and when to run interactive job  -->
<!-- b) transfer files specified in submit file  -->
<!-- c) run commands interactively  -->
<!-- d) transfer back the outputs  -->




<!-- universe = vanilla  -->
<!-- log file has time stamps etc in it  -->
<!-- executable = the name of the script that needs to run  -->
<!-- arguments = values for the script to take  -->
<!-- output and error go to their own output files  -->
<!-- queue = like a for loop ; independent jobs, each iterated over the argument -->
