...
```{r models without and without spatial stuff , echo = FALSE, warning = FALSE, message = FALSE}
 
#code for spatial and nonspatial models is in the spatial mod selection.R file 
#outputs from spatial mod selection.R include temporary output/bicspat.Rdata" and "temporary output/bicnospat.Rdata")
...
**To test Hypothesis 2**, we built models that accounted for spatial autocorrelation as well as migration using the splm package in R[@millo2023]. We again compared these models using BIC.
