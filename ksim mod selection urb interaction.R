...
# need a unique k value for each unique migration type 
krr = seq(from = -100, to = 100, by = 10)
kru = seq(from = -100, to = 100, by = 10)
kur = seq(from = -100, to = 100, by = 10)
kuu = seq(from = -100, to = 100, by = 10)
...
for (i in 1:length(krr)) {
  for (j in 1:length(kru)) {
    for (k in 1:length(kur)) { 
      for (l in 1:length(kuu)) {
